...
# Source0-md5:	f97f50fda774efc3abf4140a9426c54e
...
%attr(755,root,root) %{_libdir}/libdolphinprivate.so.24.01.95
%ghost %{_libdir}/libdolphinprivate.so.6
%attr(755,root,root) %{_libdir}/libdolphinvcs.so.24.01.95
